                    ...
                    <div class="col-md-offset-2 col-md-4">
                        ...
                        <div class="row">
                            <div class="btn-group  btn-group-justified">
                                ...
                                <a class="btn btn-success" data-toggle="tooltip" title="Displays your current playlists and their tracks" href="playlist_list.php"><i class="fa fa-list-alt" aria-hidden="true"></i> Open playlist</a>
                            </div>
                        </div>
                    </div>
                    <?php
